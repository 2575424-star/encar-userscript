...
// @version      6.0
// @description  Коммерческое предложение с логотипом и реквизитами
...
.header{background:linear-gradient(135deg,#0f2a44 0%,#1a4a6f 100%);padding:25px 40px;color:white}
.logo-area{display:flex;justify-content:space-between;align-items:center;margin-bottom:20px}
.logo-area img{height:50px;max-width:200px;object-fit:contain}
.company-info{text-align:right;font-size:11px;opacity:0.8;line-height:1.4}
.title-block{display:flex;justify-content:space-between;align-items:flex-end;border-top:1px solid rgba(255,255,255,0.2);padding-top:20px}
.car-title{font-size:28px;font-weight:700}
.manager-info{text-align:right;font-size:12px}
.manager-name{font-weight:600;margin-bottom:4px}
.validity{font-size:11px;opacity:0.7;margin-top:5px}
.section{padding:20px 40px;border-bottom:1px solid #eef2f6}
...
.info-row{display:flex;justify-content:space-between;padding:6px 0;border-bottom:1px dashed #eef2f6}
.info-label{font-size:12px;font-weight:500;color:#64748b}
...
.expense-detail-row{display:flex;justify-content:space-between;padding:3px 0;font-size:11px}
.expense-detail-label{color:#64748b}
.expense-detail-value{color:#1e293b;font-weight:500}
.price-table{width:100%;border-collapse:collapse}
.price-table th{text-align:left;padding:10px 0;font-size:12px;font-weight:600;color:#64748b;border-bottom:1px solid #eef2f6}
.price-table td{padding:10px 0;font-size:13px;border-bottom:1px solid #eef2f6}
...
.photos-section{padding:20px 40px}
.photos-grid{display:grid;grid-template-columns:repeat(2,1fr);gap:12px}
.photo-item{aspect-ratio:4/3;background:#f8fafc;border-radius:12px;overflow:hidden;border:1px solid #eef2f6}
.photo-item img{width:100%;height:100%;object-fit:cover}
.photo-item.empty{background:#f8fafc;border:1px dashed #cbd5e1}
.page-count{margin-left:auto;font-size:11px;font-weight:normal;color:#94a3b8}
.footer{background:#f8fafc;padding:15px 40px;text-align:center;font-size:10px;color:#94a3b8;border-top:1px solid #eef2f6}
.requisites{display:flex;justify-content:space-between;margin-top:10px;padding-top:10px;border-top:1px solid #eef2f6;font-size:9px}
...
<div class="header">
<div class="logo-area">
<img src="https://cdn.trx.tradedealer.ru/746/media/download/pB9Ltu__logo-indriv-e.svg" alt="Логотип" onerror="this.style.display='none'">
<div class="company-info">
<div>ИНН: 3662313297 | ОГРН: 1253600001973</div>
<div>г. Воронеж, пр. Патриотов 47и</div>
<div>тел: +7(473)233-44-55</div>
</div>
</div>
<div class="title-block">
<div class="car-title">${brand} ${model}</div>
<div class="manager-info">
<div class="manager-name">Менеджер отдела продаж<br>Александр</div>
<div>тел: +7(922)333-66-88</div>
</div>
</div>
<div class="validity">⚡ Предложение действительно 3 дня</div>
</div>
...
<div style="margin-bottom:14px;"><div style="font-weight:700;margin-bottom:6px;font-size:13px;">🇰🇷 Расходы Корея</div>
...
<div class="expense-detail-row" style="margin-top:5px;padding-top:5px;border-top:1px solid #eef2f6;"><span class="expense-detail-label" style="font-weight:bold;">ИТОГО КОРЕЯ:</span><span class="expense-detail-value" style="font-weight:bold;">${formatNumber(totalKoreaUSD)} $</span></div>
</div></div>
<div style="margin-bottom:14px;"><div style="font-weight:700;margin-bottom:6px;font-size:13px;">🇰🇬 Расходы Бишкек</div>
<div class="expense-detail">
...
<div class="expense-detail-row" style="margin-top:5px;padding-top:5px;border-top:1px solid #eef2f6;"><span class="expense-detail-label" style="font-weight:bold;">ИТОГО БИШКЕК:</span><span class="expense-detail-value" style="font-weight:bold;">${formatNumber(totalBishkekUSD)} $</span></div>
</div></div>
<div style="margin-bottom:14px;"><div style="font-weight:700;margin-bottom:6px;font-size:13px;">🇷🇺 Расходы РФ</div>
<div class="expense-detail">
...
<div class="expense-detail-row" style="margin-top:5px;padding-top:5px;border-top:1px solid #eef2f6;"><span class="expense-detail-label" style="font-weight:bold;">ИТОГО РФ:</span><span class="expense-detail-value" style="font-weight:bold;">${formatNumber(totalRFRUB)} ₽</span></div>
</div></div>
...
<span>ИНН: 3662313297</span>
<span>ОГРН: 1253600001973</span>
<span>г. Воронеж, пр. Патриотов 47и</span>
<span>тел: +7(473)233-44-55</span>
</div>
<p style="margin-top:10px;">* Данное предложение носит информационный характер и не является публичной офертой.</p>
</div>
</div>
${photosHTML ? `<div class="page">${photosHTML}<div class="footer"><p>© ${brand} ${model} — полная комплектация</p></div></div>` : ''}
</div></body></html>`;
